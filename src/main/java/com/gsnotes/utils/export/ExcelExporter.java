...
public class ExcelExporter {
	...
	private void createFormulaCell() {
		
		int moyenneInd =sheet.getRow(0).getLastCellNum()-1; // moyenne index
		
		int ValidationInd =sheet.getRow(0).getLastCellNum(); // validation index
