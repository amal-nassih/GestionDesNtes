...
public class AppGlobalExceptionHandler {
	...
	@ExceptionHandler(NoteIncorrectException.class)
	public ModelAndView NoteIncorrectExceptionHandler(Exception e) {
		...
		modelAndView.addObject("url", "ExcelImporterForScores.verifyScores");

		String view = "/prof/error";
	...
	public ModelAndView FormatExceptionHandler(Exception e) {
		...
		modelAndView.addObject("url", "ExcelImporterForScores.verifyFormat");
	...
	@ExceptionHandler(HeaderNotVerifiedException.class)
	public ModelAndView HeaderNotVerifiedExceptionHandler(Exception e) {
		...
		modelAndView.addObject("url", "ExcelImporterForScores.verifyHeader");
