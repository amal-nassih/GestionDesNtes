...
public class CompteServiceImpl implements ICompteService {
	...
	//rani bara nswb xi haja li dkhl les données initialement
	/*
	@PostConstruct
    public void init() {
    	
    	Utilisateur person = personDao.getById(new Long(0));
		...
		Role r = new Role();
		r.setIdRole(new Long(11));
		r.setNomRole("ADMIN");
		
		userAccount.setRole(r);


		String passw = generatePassayPassword();
		String encodedPass = passwordEncoder.encode(passw);

		System.out.println("my passwd = "+passw+" -----creating you : "+ encodedPass);
		userAccount.setPassword(encodedPass);
