...
public class PersonServiceImpl implements IPersonService {
	...
	@Override
	public Long getUserByNom(String nom, String prenom) {
		
		if(personDao.getUtilisateurByNomAndPrenom(nom, prenom)==null) {
			return new Long(0);
		}
		return personDao.getUtilisateurByNomAndPrenom(nom, prenom).getIdUtilisateur();
	}
